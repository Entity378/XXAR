...
class ReplaceAudioWorker(QThread):
    ...
    def __init__(self, custom_file_path, meta, normalize, mod_manager, normalize_lufs=-9):
        super().__init__()
...
class AudioBrowserBridge(QObject):
    ...
    def replaceWithCustomAudio(self, item_id, item_type, pck_path, normalize=True, parent_bnk=""):
        ...
        self._replace_worker = ReplaceAudioWorker(filename, meta, normalize, self.mod_manager, self.normalize_target_lufs)
